...
export const MAPS: MapDef[] = [
  ...
  { id: '65f735f75421bc39c98c3dac', name: 'An Extensive Greece', aliases: ['greece', 'extensive greece'], mode: 'subdivision', countryCode: 'GR' },
  { id: '62face686a6b3898fa1ca37d', name: 'A Balanced Greenland', aliases: ['greenland', 'balanced greenland'], mode: 'subdivision', countryCode: 'GL' },
  ...
  { id: '653b2196685acb6e827bb4de', name: 'A Balanced AI Generated Italy', aliases: ['italy', 'balanced italy'], mode: 'subdivision', countryCode: 'IT' },
  { id: '64f4959080229b9a3d429041', name: 'A Balanced Philippines', aliases: ['philippines'], mode: 'subdivision', countryCode: 'PH' },
  { id: '64f7824aae1d156d26e056a3', name: 'An Arbitrary Norway', aliases: ['norway', 'arbitrary norway'], mode: 'subdivision', countryCode: 'NO' },
  { id: '6519072a4a389548ed9d4a67', name: 'An Arbitrary Peru', aliases: ['peru', 'arbitrary peru'], mode: 'subdivision', countryCode: 'PE' },
  { id: '644fc1e0385ec9758e0f28f5', name: 'An Arbitrary Rural Russia (AARRU)', aliases: ['russia', 'aarru', 'arbitrary rural russia'], mode: 'subdivision', countryCode: 'RU' },
